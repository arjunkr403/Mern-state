...
export default function UpdateListing() {
  ...
  //used to fetch data after the page has been rendered
  useEffect(() => {
  ...
  // '[]' ensures that effect runs 1 time only after initial render
  ...
  const handleChangeList = (e) => {
    ...
    if (
      ...
      setFormData({
        //change the formData with following data
        ...formData, //keep previous information
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // as the condition for number and text taken together the value of number type may save as string , so to avoid that error we use '+' for the number attributes such that they dont change their type to string or etc.
      ...
      >
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <button
            ...
            className="border bg-rnd text-txt2 rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-80 my-7"
          >
